        ...
        <div class="hero">
            <div class="hero-content flex-col-reverse lg:flex-row-reverse">
                <div className='flex justify-center gap-5'>
                    <a href="https://bike-hub-b9899.web.app/"><button className="btn btn-outline brightness-50 hover:brightness-100">Live Site</button></a>
                    <a href="https://github.com/Yeasir-Hossain/bike-warehouse-client"><button className="btn btn-outline brightness-50 hover:brightness-100">Client Code</button></a>
                    <a href="https://github.com/Yeasir-Hossain/bike-warehouse-server"><button className="btn btn-outline brightness-50 hover:brightness-100">Server Code</button></a>
                </div>
                <div>
