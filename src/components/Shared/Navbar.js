                    ...
                    <ul tabindex="0" class="menu menu-compact dropdown-content mt-3 p-2 shadow bg-base-100 rounded-box w-52">
                        <div class="btn-group">
                            ...
                            <a href="https://drive.google.com/file/d/1vIZ5aEvKnnY1cM68ABrIMhKEV7us7ynJ/view?usp=sharing" target="_blank" rel='noreferrer'>
                                <button class="custom-btn btn-12 my-1 ml-5"><span>Download</span><span>Resume</span>
                                </button>
                            </a>
                            <HashLink smooth to="#contact">
                                <button class="custom-btn btn-12 my-1 ml-5"><span>Me</span><span>Contact</span>
                                </button>
                            </HashLink>;
                            <HashLink smooth to="#about">
                                <button class="custom-btn btn-12 my-1 ml-5"><span>Me</span><span>About</span>
                                </button>
                            </HashLink>;
